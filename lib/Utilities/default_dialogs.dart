...
class DefaultDialogs{
  //showDeleteDialog
  static Future<dynamic> showDialog({String title = "Title",String text = "Stay with Hidmona", String onSubmitText = "Submit", Function()? onSubmit, String cancelText="Cancel",Function()? onCancel}) {
