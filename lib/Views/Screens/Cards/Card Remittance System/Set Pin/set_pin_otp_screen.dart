...
class SetPinOTPScreen extends StatefulWidget {
  const SetPinOTPScreen({Key? key}) : super(key: key);

  @override
  State<SetPinOTPScreen> createState() => _SetPinOTPScreenState();
}

class _SetPinOTPScreenState extends State<SetPinOTPScreen> {
