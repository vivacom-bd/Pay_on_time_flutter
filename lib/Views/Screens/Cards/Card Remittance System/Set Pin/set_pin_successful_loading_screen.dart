...
class SetPinSuccessfulLoadingScreen extends StatefulWidget {
  const SetPinSuccessfulLoadingScreen({Key? key}) : super(key: key);

  @override
  State<SetPinSuccessfulLoadingScreen> createState() => _SetPinSuccessfulLoadingScreenState();
}

class _SetPinSuccessfulLoadingScreenState extends State<SetPinSuccessfulLoadingScreen> {
