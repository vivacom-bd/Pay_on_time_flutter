...
class CardConfirmationAfterActiveScreen extends StatefulWidget {
  const CardConfirmationAfterActiveScreen({Key? key}) : super(key: key);

  @override
  State<CardConfirmationAfterActiveScreen> createState() => _CardConfirmationAfterActiveScreenState();
}

class _CardConfirmationAfterActiveScreenState extends State<CardConfirmationAfterActiveScreen> {
