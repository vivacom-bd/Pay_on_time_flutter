...
import 'package:hidmona/Views/Screens/Cards/Card%20Remittance%20System/Card%20Loading/New%20Card%20Details/Set%20Pin/new_card_set_pin_successful.dart';
...
class DialogForNewCardSetPinMyCard extends StatelessWidget {
  const DialogForNewCardSetPinMyCard({
    Key? key,
  }) : super(key: key);
              ...
              onTap: () async {
                if(pinController.text.isNotEmpty){
                  ...
                  if(value){
                    ...
                    Get.to(const NewCardSetPinSuccessfulMyCardScreen());
                  }
