...
class SetPinSuccessfulMyCardScreen extends StatefulWidget {
  const SetPinSuccessfulMyCardScreen({Key? key}) : super(key: key);

  @override
  State<SetPinSuccessfulMyCardScreen> createState() => _SetPinSuccessfulMyCardScreenState();
}

class _SetPinSuccessfulMyCardScreenState extends State<SetPinSuccessfulMyCardScreen> {
