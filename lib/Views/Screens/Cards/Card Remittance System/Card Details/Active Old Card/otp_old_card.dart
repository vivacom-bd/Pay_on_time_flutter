...
import 'package:hidmona/Views/Screens/Cards/Card%20Remittance%20System/Card%20Details/Active%20Old%20Card/activate_old_card.dart';
import 'package:hidmona/Views/Widgets/custom_text_form_field.dart';
import 'package:hidmona/Views/Widgets/default_button.dart';

class OTPOldCardScreen extends StatefulWidget {
  const OTPOldCardScreen({Key? key}) : super(key: key);

  @override
  State<OTPOldCardScreen> createState() => _OTPOldCardScreenState();
}

class _OTPOldCardScreenState extends State<OTPOldCardScreen> {
              ...
              children: [
                ...
                DefaultButton(
                  ...
                  onTap: () async {
                    ...
                    if(value){
                      Get.to(const ActivateOldCardScreen());
                    }else{Get.back();}
                  },
                ),
                const SizedBox(height: 15,),
