...
class ViewPinOtpMyCardScreen extends StatefulWidget {
  const ViewPinOtpMyCardScreen({Key? key}) : super(key: key);

  @override
  State<ViewPinOtpMyCardScreen> createState() => _ViewPinOtpMyCardScreenState();
}

class _ViewPinOtpMyCardScreenState extends State<ViewPinOtpMyCardScreen> {
